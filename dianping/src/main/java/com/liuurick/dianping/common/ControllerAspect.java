package com.liuurick.dianping.common;

import com.liuurick.dianping.controller.admin.AdminController;
...
public class ControllerAspect {
    ...
    @Around("execution(* com.liuurick.dianping.controller.admin.*.*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping)")
