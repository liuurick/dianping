...
import com.liuurick.dianping.recommend.RecommendService;
import com.liuurick.dianping.recommend.RecommendSortService;
import com.liuurick.dianping.service.CategoryService;
import com.liuurick.dianping.service.SellerService;
...
//        }).collect(Collectors.toList());
    ...
    public List<ShopModel> recommendByCategoryId(Integer categoryId, BigDecimal longitude, BigDecimal latitude) {
        List<ShopModel> shopModelList = shopModelMapper.recommendByCategoryId(categoryId,longitude, latitude);
        shopModelList.forEach(shopModel -> {
            shopModel.setSellerModel(sellerService.get(shopModel.getSellerId()));
            shopModel.setCategoryModel(categoryService.get(shopModel.getCategoryId()));
        });
